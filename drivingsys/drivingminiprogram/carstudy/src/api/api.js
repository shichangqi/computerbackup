 ...
 * @param {*} data 
 */
export const sendPhoneCode = data => request.get(hostName+'/miniapp/sendPhoneCode', formatGetUri(data))
 ...
 * @param {*} data 
 */
export const schoollist = data => request1.post(hostName1+'/school/lists',data)
