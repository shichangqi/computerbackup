<template>
  <div class="detail">
    ...
    <p class="transNo">交易编号：{{list.invoiceNo}}</p>
    <p class="transtime">交易时间：{{list.purchaseTimeLocal}}</p>
    <div class="title">交易凭证</div>
    <p class="none" v-if="list.imageUrl.length == 0">暂无凭证</p>
...
export default {
  ...
  onLoad(query){
    ...
    this.imageUrl = this.list.imageUrl;
  }
};
</script>
