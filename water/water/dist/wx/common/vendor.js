...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__home__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__api_index__ = __webpack_require__(46);
...
var store = new __WEBPACK_IMPORTED_MODULE_4_vuex__["a" /* default */].Store({
  modules: {
    // users,
    home: __WEBPACK_IMPORTED_MODULE_5__home__["a" /* default */]
  },
  state: {
    windowHeight: null,
    token: null,
  ...
  mutations: {
    ...
    RECORD_TOKEN: function RECORD_TOKEN(state, token) {
      state.token = token;
    },
    RECORD_CODE: function RECORD_CODE(state, code) {
      state.code = code;
    }
  },
  actions: {
    getAccessToken: function getAccessToken(_ref, params) {
      var _this = this;
          ...
          return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return Object(__WEBPACK_IMPORTED_MODULE_6__api_index__["c" /* queryToken */])(params);
  ...
  getters: {
    token: function token(state) {
      return state.token || wx.getStorageSync('token');
    }
  }
});
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return queryToken; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getDetails; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getAddress; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_fetch__ = __webpack_require__(94);


// 获取token
var queryToken = function queryToken(data) {
  return __WEBPACK_IMPORTED_MODULE_0__utils_fetch__["a" /* default */].get('/wx_code/wx-token', data);
};
// 根据经纬度或id查询水质
var getDetails = function getDetails(data) {
  return __WEBPACK_IMPORTED_MODULE_0__utils_fetch__["a" /* default */].get('/wx/monitoring/details', data);
};
// 根据名称查询省市区
var getAddress = function getAddress(data) {
  return __WEBPACK_IMPORTED_MODULE_0__utils_fetch__["a" /* default */].get('/wx/monitoring/getAddress', data);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api__ = __webpack_require__(46);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mutations: {
    RECORD_DETAILS: function RECORD_DETAILS(state, details) {
      state.details = details;
    },
    RECORD_ADDRESS: function RECORD_ADDRESS(state, Address) {
      state.Address = Address;
    }
  },
  actions: {
    getDetails: function getDetails(_ref, params) {
      var _this = this;
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(__WEBPACK_IMPORTED_MODULE_2__api__["b" /* getDetails */])(params);
    ...
    getAddress: function getAddress(_ref3, params) {
      var _this2 = this;
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Object(__WEBPACK_IMPORTED_MODULE_2__api__["a" /* getAddress */])(params);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugins_toast__ = __webpack_require__(96);



// import {getCookie} from '../utils/cookie'
var fetch = new __WEBPACK_IMPORTED_MODULE_0_flyio_dist_npm_wx___default.a();

fetch.config.baseURL = 'https://tyjwxb.f.wmeimob.com/app';

fetch.interceptors.request.use(function (req) {
  if (__WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getters.token) {
    req.headers['authorization'] = __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getters.token;
  }
  __WEBPACK_IMPORTED_MODULE_2__plugins_toast__["a" /* default */].showLoading('加载中');
  return req;
});

fetch.interceptors.response.use(function (response, promise) {
  __WEBPACK_IMPORTED_MODULE_2__plugins_toast__["a" /* default */].hideLoading();
  ...
  switch (err.status) {
    case 401:
      ...
      break;
    case 405:
      __WEBPACK_IMPORTED_MODULE_2__plugins_toast__["a" /* default */].text('您的账号已被禁用');
      break;
    default:
  }
...
"use strict";
var toast = {
  text: function text(_text, callback) {
    wx.showToast({
      icon: 'none',
      title: _text
    });
