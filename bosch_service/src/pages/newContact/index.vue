<template>
  <div class="newContact">
    <div class="form">
      <div class="panel">
        <label>手机号</label>
        <input type="number"placeholder="请输入手机号" placeholder-style="color:rgba(184,195,202,1);font-size:14px"maxlength="11" v-model="phone" >
      </div>
      ...
      <div class="panel surname">
        ...
        <input
          type="text"
          placeholder="请输入您的姓氏"
          placeholder-style="color:rgba(184,195,202,1);font-size:14px"
          v-model="surname"
        >
      </div>
...
<script>
  ...
  import { getAreaInfo, addAddress, getcode ,getToken} from "../../api/api";
