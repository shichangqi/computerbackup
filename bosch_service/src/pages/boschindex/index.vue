  ...
  <div class="boschindex">
    <div class="index" v-if="curindex == 0">
      ...
      <div class="content">
        <div class="product">
          <img
            v-if="isQR"
            :src="prodectInfo.logo"
            alt
            class="pro_logo_selected"
          >
          <img
            v-if="isQR == false"
            src="../../static/images/pro_logo_sele.png"
            alt
            class="pro_logo_sele"
          >
          <div class="right" v-if="isQR">
            <p class="p1">
              ...
              <span class="name"> &nbsp;{{productType}}</span>
            </p>
          ...
          <swiper-item>
            <div class="swiper1">
              <div class="content1" v-if="!getphone">
                ...
                <div class="item">
                  <button open-type="contact" @contact="handleContact" class="iboot" v-if="first"></button>
    ...
    <div class="bottom">
      <div class="item" v-for="(bt,index) in bottomtab" :key="index" :class="{'active':curindex == index}">
        ...
        <img
          :src="bt.selected ? bt.selectedurl:bt.imgurl"
          :class="{'kefu':index == 1}"
          @tap="target(index)">
      ...
      wx.login({
          success:function(res) {
            ...
            getUserPhone(da).then(res=>{
              ...
              // navigate(`/pages/home/install/main?productinfo=${JSON.stringify(_this.prodectInfo)}`);
            })
          ...
          success:function(res) {
            ...
            getUserPhone(da).then(res=>{
              ...
              wx.setStorageSync('phone', res.data.purePhoneNumber);
                ...
                // if(_this.isQR){
                //   if(_this.prodectInfo.name == '家用小电器'){
                //     navigate(`/pages/home/repairhousehold/main?productinfo=${JSON.stringify(_this.prodectInfo)}`)
                //   }else{
                //     navigate(`/pages/home/repairnothousehold/main?productinfo=${JSON.stringify(_this.prodectInfo)}`)
                //   }
                // }else{
                //   navigate(`/pages/home/repairhousehold/main?productinfo=${JSON.stringify(_this.prodectInfo)}`)
                // }
...
.boschindex {
  ...
  .content {
    ...
    .product {
      position: relative;
      top: -45px;
      background: url("../../static/images/product_bg.png") no-repeat;
