import {bsrequest,request,notrequest,lightrequest,waterrequest} from "./request";
...
// const mmhostName = 'http://wxb.frp.dev.wmeimob.com/apd'
const mmhostName = 'https://mpmtest.bshg.com.cn/boschqr'
//const mmhostName = 'https://tyjwxb.f.wmeimob.com/boschqr'

// const lshostName = 'https://boschcstest.bshg.com.cn/apd'
// const mmhostName2 = 'http://adminb.frp.dev.wmeimob.com/api'
const mmhostName2 = 'https://cmstest.bshg.com.cn/api'
const water = 'https://tyjwxb.f.wmeimob.com/boschqr'
 ...
 */
export const getwater = data => request.get(water+'/wx_code/wx-token', formatGetUri(data))
 ...
 * @returns {FlyPromise<any>}
 */
export const getwaterdetail = data => request.get(water+'/wx/monitoring/details', formatGetUri(data))
 ...
 * @returns {FlyPromise<any>}
 */
export const getwateraddress = data => request.get(water+'/wx/monitoring/getAddress', formatGetUri(data))
 ...
 * @returns {FlyPromise<any>}
 */
export const getlight = data => lightrequest.get( 'https://icore-ws3.bsh-partner.com/extapp/productinformation/productfull/v1/'+data.vib)
// export const getlight = data => lightrequest.get( 'https://icore-ws3.bsh-partner.com/extapp/productinformation/productfull/v1/KMF40S65TI')
