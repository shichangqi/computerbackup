      ...
      <div class="func">
        <div class="item" @tap="productHelper">
          <img src="../../../static/images/index_1.png" alt="">
            <p class="p1" v-if="!isQR">产品家族</p>
            <p class="p2" v-if="!isQR">Product Family</p>
          <p class="p1" v-if="isQR">产品助手</p>
          <p class="p2" v-if="isQR">Product Assistant</p>
        </div>
        ...
        <navigator target="miniProgram" open-type="navigate" app-id="wx3b6c1220247bae84" :extra-data="productmodalinfo" path="pages/boschindex/main" version="trial" hover-class="none">
        ...
        <div class="item" @click="gowater" v-if="!water">
          <img src="../../../static/images/index_4.png" alt="">
          <p class="p1">水硬度</p>
          <p class="p2">Service eShop</p>
        </div>
...
import {navigate} from "../../utils/index";
  ...
  export default {
    ...
    onLoad(options){
      ...
      if(str != 'undefined' && str != null && str != '' || (options.EN)){
      ...
      if(this.productmodalinfo.id == null){
        ...
        // this.productmodalinfo.brand =  "博世";
