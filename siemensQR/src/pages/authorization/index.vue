...
<script>
  ...
  export default {
    ...
    onLoad (options) {
      ...
      console.log(options, 'optionsoptionsoptionsoptions111111')
      ...
      this.isQR = true
      console.log(this.query, 'this.querythis.querythis.query1111')
    },
    methods: {
      // 获取地址栏信息
          ...
          success (resLogin) {
            ...
            if (resLogin.code) {
              ...
              _this.getAccessToken(data).then(res => {
                ...
                // goBack();
                // console.log('this.query333333333', _this.query)
                // wx.redirectTo({
                //   url: '/pages/boschindex/main' + (_this.query ? '?'+formatGetUri(_this.query)  : '')
                // })
              }).catch((error) => {
                console.log(error)
              })
